...
print('''\r\n
Phiên Bản: 1.0
[Chỉ phục vụ mục đích học tập tìm hiểu]   
© Copyright 2021 - Đỗ Trần Bình(dtrbinh)
Based on Pummel by HC133          
├─────────────────────────────────────────────────────┤
[!Từ chối mọi trách nhiệm nếu người sự dụng nó cho mục đích xấu!]
\r\n''')
...
def prevent():
    if '192.168' in ip or '127.0' in ip or '172.16' in ip or 'localhost' in ip :
        print("Vùng IP đã nhập là localhost! Đừng có ấn nút tự huỷ :>")
    if 'gov.vn' in ip :
        print("Cảnh cáo! Không được phép tấn công trang web của chính phủ Việt Nam!.")
        exit()
